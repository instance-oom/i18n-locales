...
declare module '@vue/runtime-core' {
  ...
  export interface ComponentCustomProperties {
    $translate: (key: Leaves<InstanceOOM.I18nLocalesKeyType>, named?: Record<string, unknown>, options?: TranslateOptions<string> | undefined) => string
  }
}`.trim();
  ...
  return {
    ...
    async handleHotUpdate({ file, server }: any) {
      if (/\.(json5?)$/.test(file)) {
        ...
        const modules = [server.moduleGraph.getModuleById(RESOLVED_MESSAGES_VIRTUAL_MODULE_ID)];
